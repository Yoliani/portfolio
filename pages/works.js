      ...
      <SimpleGrid columns={[1, 1, 2]} gap={6}>
        ...
        <Section delay={0.3}>
          <WorkGridItem
            ...
            thumbnail={thumbNike}
          >
            Nike requires a sales system for its products, in which users can
            see the products they offer, so that their customers can view, rate
            them and offer their opinion through a comment.
          </WorkGridItem>
        </Section>
        <Section delay={0.3}>
          <WorkGridItem
            id="la-gabarra"
            title="La Gabarra S.A.S"
            thumbnail={thumbGabarra}
          >
            Website of an ocean freight forwarder company
          </WorkGridItem>
        </Section>
      </SimpleGrid>
    </Container>
